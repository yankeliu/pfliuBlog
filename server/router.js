...
router.post('/admin/article/publish', function(req, res) {
...
router.get('/admin/draft/list', function(req, res){
...
//添加新标签路由
router.post('/admin/labels/new', function(req, res) {
...
// 查询标签列表
router.get('/admin/labels/list', function(req, res){
...
//上传照片
router.post('/admin/image/upload', function(req, res) {
...
// 查询标签中文章列表
router.get('/admin/labelDetails/:id', function(req, res){
  var id = req.params.id
  Label.find({_id: id})
...
// 删除文章
router.delete('/admin/articleDelete/:id', function(req, res){
  var id = req.params.id
  Article.findById(id, function(err, article) {
      if (err) {
        console.log(err)
...
// 删除标签
router.delete('/admin/labelDelete/:id', function(req, res){
  var id = req.params.id
...
router.post('/admin/login', function(req, res) {
  var user = req.body;
  if (findUser(user.user_name, user.password)) {
